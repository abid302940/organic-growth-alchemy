...
const InstagramPage = () => {
  // Filter testimonials for Instagram only
  const instagramTestimonials = testimonialsData.filter(
    (testimonial) => testimonial.platform === "Instagram"
  );
  ...
  const instagramLikesTiers = [
    ...
    },
    {
      ...
      quantity: "10000+ Likes",
      features: [
        "No password required",
        "Priority delivery in 2-4 days",
        "Real users",
        "30-day guarantee",
        "Comments, saves & shares included",
        "Analytics report",
        "24/7 support"
      ]
    }
  ...
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section className="bg-gradient-to-br from-pink-50 to-white py-16 md:py-24">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              >
                <Badge className="bg-instagram/10 text-instagram border-instagram/20 mb-4 px-3 py-1">
                  Instagram Growth Services
                </Badge>
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
                  Amplify Your <span className="text-instagram">Instagram</span> Presence with Real Engagement
                </h1>
                <p className="text-xl text-gray-600 mb-8">
                  Elevate your Instagram profile with our 100% organic growth services. Get real followers and engagement from genuine users interested in your content.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Button size="lg" asChild>
                    <a href="#pricing" className="bg-instagram hover:bg-instagram/90 text-white">
                      View Pricing
                    </a>
                  </Button>
              ...
              >
                ...
                <div className="absolute top-4 right-4 bg-white rounded-full shadow-lg p-4">
                  <Instagram className="h-10 w-10 text-instagram" />
                </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We deliver real growth that lasts. Our Instagram services help you build a sustainable profile with genuine engagement.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <div className="w-14 h-14 bg-pink-100 rounded-full flex items-center justify-center mb-6">
                  <svg className="w-7 h-7 text-instagram" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              >
                ...
                <p className="text-gray-600">
                  We match your content with interested followers in your niche, ensuring high-quality engagement that boosts your profile's credibility.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  Our growth patterns are designed to look natural to Instagram's algorithm, helping your content get featured more often.
                </p>
              </motion.div>
            </div>
          </div>
        ...
        <div id="pricing">
          <PricingSection 
            ...
            description="Grow your profile with real followers who engage with your content"
            platform="Instagram"
            serviceType="Followers"
            tiers={instagramFollowersTiers}
          />
          
          <PricingSection 
            title="Instagram Likes" 
            description="Increase your post engagement with genuine likes from real people"
            platform="Instagram"
            serviceType="Likes"
            tiers={instagramLikesTiers}
          />
        </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-600">
                  Select the service and package that best fits your profile's needs and goals.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Provide Profile Details</h3>
                <p className="text-gray-600">
                  Simply share your Instagram username (no password required) and complete your order.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-3">Watch Your Profile Grow</h3>
                <p className="text-gray-600">
            ...
            <div className="mt-12 text-center">
              <Button size="lg" className="bg-instagram hover:bg-instagram/90 text-white">
                Get Started Today
              </Button>
            </div>
          </div>
        ...
        {/* Testimonials */}
        <TestimonialsSection testimonials={instagramTestimonials.length > 0 ? instagramTestimonials : testimonialsData.slice(0, 3)} />
        ...
        <section className="py-16 bg-gradient-to-br from-pink-50 to-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Join thousands of influencers and brands who have boosted their Instagram profile with our organic growth services.
            </p>
            <Button size="lg" className="bg-instagram hover:bg-instagram/90 text-white px-8 py-6 text-lg">
              Get Started Now
            </Button>
